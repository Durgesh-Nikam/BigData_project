...
with DAG(
    ...
    start_kafka_producers = BashOperator(
        ...
        python3 ~/Downloads/BigData_project/kafka/producer_weather.py &
        python3 ~/Downloads/BigData_project/kafka/producer_soil.py &
        """,
    )
    ...
    spark_streaming = BashOperator(
        ...
        spark-submit ~/Downloads/BigData_project/spark/streaming_predictions.py
        """,
    )
